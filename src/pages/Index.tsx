  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-gradient-radial from-amber/20 via-gold/10 to-transparent blur-3xl opacity-60 animate-gentle-pulse" />
      ...
      <div className="relative z-10 container max-w-2xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-4 text-gold-gradient animate-shimmer bg-[length:200%_auto] drop-shadow-[0_0_20px_rgba(255,215,0,0.5)]">
            Menorah in The Square
          </h1>

          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-gold-gradient font-light tracking-wide animate-shimmer bg-[length:200%_auto]">
        ...
        <div className="relative animate-fade-in animation-delay-200">
          ...
          <div className="absolute -inset-6 bg-gradient-to-br from-gold/30 via-amber/20 to-gold/20 rounded-3xl blur-3xl opacity-40 animate-gentle-pulse" />
          ...
          {/* Main Glass Card */}
          <div className="relative glass-card rounded-3xl shadow-2xl p-8 md:p-12 border border-gold/20">
            {/* Subtle inner glow */}
            ...
            <div className="flex justify-center mb-8 relative z-10">
              <div className="text-3xl animate-candle-flicker">✨</div>
            </div>
